...
const routes = [
  ...
  { path: '/', name: 'dashboard', component: Dashboard, meta: { title: '运营仪表盘', icon: 'Odometer', perm: 'overview:read' } },
  ...
  { path: '/tasks', name: 'tasks', component: TaskList, meta: { title: '修复流程', icon: 'Tools', perm: 'task:read' } },
  { path: '/tasks/:id', name: 'task-detail', component: TaskDetail, meta: { title: '流程监控', hidden: true, perm: 'task:read' } },
  { path: '/statistics', name: 'statistics', component: Statistics, meta: { title: '统计报表', icon: 'Histogram', perm: 'stats:read' } },
